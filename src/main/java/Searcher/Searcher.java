...
public class Searcher {
    ...
    private ArrayList<String> search( String queryString, TreeMap<String, String> dict, TreeMap<String, String> cache, TreeMap<String, String> docs, ArrayList<String> cities, boolean totalRickAll) {
    ...
    public void multiSearch( ArrayList<QuerySol> queryList, TreeMap<String, String> dict, TreeMap<String, String> cache, TreeMap<String, String> docs, ArrayList<String> cities, boolean totalRickAll) {
