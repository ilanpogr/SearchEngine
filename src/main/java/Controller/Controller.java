...
//            PropertiesFile.putProperty("data.set.path", "C:\\Users\\User\\Documents\\לימודים\\אחזור מידע\\מנוע חיפוש\\");
...
//            ReadFile readFile = new ReadFile(corpusPath+"corpus\\");
//            Parse p = new Parse();
//            Indexer indexer = new Indexer();
//            indexer.removeAllFiles();
//            double fileparse = 0;
